        ...
        ConfGlobalMFM = cms.PSet(
            OCMS = cms.PSet(
                ...
                StepperParam = cms.PSet(
                    ...
                    MaxStep = cms.double(100000.0),
                    MaxStepSimple = cms.double(100000.0),
...
process.psimTask = cms.Task(process.g4SimHits, process.randomEngineStateProducer)
...
process.simulation_step = cms.Path(cms.Task(process.g4SimHits, process.randomEngineStateProducer))
...
process.schedule = cms.Schedule(*[ process.simulation_step, process.endjob_step, process.RAWSIMoutput_step ], tasks=[process.patAlgosToolsTask])
